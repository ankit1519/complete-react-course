...
function App() {
  ...
  return (
    <div className="screen" style={{backgroundColor:color}}>
      <div className='fixed flex flex-wrap  justify-center bottom-12 inset-x-0 px-2 my-3'>
        <div className='fixed flex flex-wrap justify-center gap-3 shadow-2xl bg-white px-3 py-2 rounded-3xl'>
